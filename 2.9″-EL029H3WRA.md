...
* 2.9” ePaper display (SSD1619 or UC-something) (BWR) 384x168px
* 1Mbyte SPI flash
* 2x CR2450 button cell
* Optional [[NXP NFC controller (I2C)|NFC-Solum-2.9"-and-1.54"]]

There are multiple versions of these tags, these are the ones we know of:
* Sep 16 2020 - Rev 07 - Uses some variant of a UC controller
* Nov 20 2021 - Rev 11 - Uses a variant of the SSD1619 controller
...
Opening the battery cover can be a bit tricky. Here is how to do that: https://youtu.be/d0R1Od2vCcI
